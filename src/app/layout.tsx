  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-[#0f172a] text-[#f8fafc] relative overflow-x-hidden">
        ...
        <div className="absolute top-[-200px] left-1/4 w-[600px] h-[600px] bg-glow-blue pointer-events-none z-0 rounded-full" />
        <div className="absolute top-[40%] right-[-100px] w-[600px] h-[600px] bg-glow-purple pointer-events-none z-0 rounded-full" />
